      ...
      <div class="flex flex-wrap items-center mb-16">
        {
            ...
            <>
                ...
                >
                    ...
                    />
                    <a href="#!">
                    <div class="absolute overflow-hidden top-0 right-0 bottom-0 left-0 h-full w-full bg-[hsl(0,0%,0%,0.4)] bg-fixed">
                    ...
                    <div class="relative overflow-hidden bg-cover bg-no-repeat">
                        <div class="absolute overflow-hidden top-0 right-0 bottom-0 left-0 h-full w-full bg-[hsl(0,0%,98.4%,0.2)] bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-100"></div>
                    </div>
                    </a>
                </div>
                </div>
