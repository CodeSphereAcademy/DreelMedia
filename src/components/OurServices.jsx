    ...
    <section className="bg-gray-100 text-black" id="Services">
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-4 md:text-xl text-gray-800">
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          <a
            ...
            href="#"
            style={{borderColor:'#12254D'}}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="size-12" style={{color:'#12254D'}}
              fill="currentColor"
              viewBox="0 0 16 16"
            >
            ...
            <h2 className="mt-4 text-xl font-bold" style={{color:'#12254D'}}>
              Technology Services
            </h2>
          ...
          <a
            style={{borderColor:'#12254D'}}
            className="block rounded-xl border bg-white p-8 shadow-xl transition"
            href="#"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="size-12 -rotate-12 " style={{color:'#12254D'}}
              fill="currentColor"
              viewBox="0 0 16 16"
            >
          ...
          <a
            style={{borderColor:'#12254D'}}
            className="block rounded-xl border p-8 shadow-xl transition bg-white"
            href="#"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
